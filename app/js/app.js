...
},{"./board":158,"react":155}],158:[function(require,module,exports){
'use strict';
...
var Board = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    this.bindAsArray(new Firebase('https://contents.firebaseio.com/game/categories/'), 'categories');
    this.bindAsArray(new Firebase('https://contents.firebaseio.com/game/players/'), 'players');
  },
  ...
  render: function render() {
    var allCategories = this.state.categories.map(function (c) {
      return React.createElement(
        'div',
        { className: 'col-xs-2', key: c.id },
        React.createElement(Category, { key: c.id, category: c })
      );
    });
    var allPlayers = this.state.players.map(function (p) {
      return React.createElement(
        'div',
        { className: 'col-xs-4', key: p.id },
        React.createElement(Player, { key: p.id, player: p })
      );
    });
...
},{"./category":159,"./player":160,"./quizbox":161,"react":155}],159:[function(require,module,exports){
'use strict';
...
var Category = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    this.bindAsArray(new Firebase('https://contents.firebaseio.com/game/quizzes/'), 'quizzes');
  },
  ...
  render: function render() {
    ...
    var categoryPoints = this.state.quizzes.map(function (point) {
      ...
      return React.createElement(
        'div',
        { className: 'category-points' },
        React.createElement(
          'button',
          { className: 'category-btn btn' + btnStatus,
            key: point.id },
          point.value
        )
      );
    ...
    return React.createElement(
      'div',
      { className: 'category', key: this.props.category.id },
      React.createElement(
        'div',
...
var Player = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'player-score ' + scoreValue },
        score
      ),
      React.createElement(
        'div',
...
var QuizBox = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'section',
      { className: 'quizzes row well' },
      React.createElement(
        'div',
        { className: 'questions col-xs-7' },
        'When the future state of Iowa, became part of the United States, this man was President.'
      ),
      React.createElement(
        'div',
        { className: 'answers col-xs-5' },
        React.createElement(
          'div',
          { className: 'answers-buttons btn-group-vertical' },
          React.createElement(
            'button',
            { className: 'btn btn-danger' },
            'A. Washington'
